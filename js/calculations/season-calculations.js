...
export function rankForGame(game = {}, team = {}, fallback = DEFAULT_SEASON_ID) { const seasonId = effectiveSeasonId(game, fallback), label = seasonLabelForId(seasonId), value = team.seasonRanks?.[label] || team.teamSeasonData?.[seasonId]; return value?.rank || team.calculatedRank || team.teamRank || team.rank || null; }
