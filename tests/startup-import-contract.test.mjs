...
assert.ok(app.includes('from "./calculations/participation-calculations.js?v=20260821-min-display-v2"'),"new participation exports must use a cache-busted module URL");
