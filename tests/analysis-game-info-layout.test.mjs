...
assert.match(css, /\.basic-stats-min\{[^}]*color:var\(--orange\)/);
assert.doesNotMatch(css, /\.basic-stats-title\{[^}]*flex-direction:column/);
assert.match(index, /min-display\.css\?v=20260821-2/);
assert.match(index, /js\/app\.js\?v=20260821-analysis-info-layout-v1/);
