...
assert.doesNotMatch(app,/id="registerFoul"/);assert.match(app,/FOUL\$\{numInput\('pf'/);assert.match(app,/被FOUL\$\{numInput\('fouled'/);assert.match(app,/playEvents\s*=\s*reconciled\.playEvents/);
