...
assert.match(app, /await saveAssistPlay\(game,\{kind:'saveShot',shot,edit:Boolean\(editingShot\)\},quarter\|\|1\);if\(!finishHistoryEdit\(game,quarter\|\|1\)\)statsForm\(gameId,quarter\)/);
