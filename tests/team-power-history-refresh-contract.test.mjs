...
assert.match(app, /TEAM_POWER_HISTORY_REFRESH_VERSION='2026-09-15-team-power-zero-history-v1'/);
...
assert.match(index, /app\.js\?v=20260915-team-power-zero-history-v1/);
assert.match(app, /service-worker\.js\?v=20260915-team-power-zero-history-v1/);
assert.match(sw, /r32-shell-20260915-team-power-zero-history-v1/);
