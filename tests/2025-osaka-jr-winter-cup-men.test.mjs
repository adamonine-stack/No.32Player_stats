...
const opponentPlacementsSource=app.match(/function opponentPlacements\(team=\{\}\)\{[^\n]+\}/)?.[0];
assert.ok(opponentPlacementsSource);
assert.equal(Function(`${opponentPlacementsSource};return opponentPlacements(null).length`)(),0);
