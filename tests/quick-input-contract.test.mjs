...
for(const marker of ['<h2>スタッツ登録</h2>','function quickActionSheet','quick-selected-player','id="quickChangePlayer"','data-quick-action="out"'])assert.ok(app.includes(marker),marker);
