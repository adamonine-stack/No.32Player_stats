const CACHE_NAME = 'r32-shell-20260906-settings-cleanup-v1';
const APP_SHELL = [
  './', './index.html', './manifest.json', './styles/quick-keyboard.css?v=20260906-v2', './js/ui/quick-keyboard.js?v=20260905-v1', './js/ui/game-history-fixed-nav.js?v=20260906-final-action-v1', './js/ui/game-history-edit-position.js?v=20260905-v1', './js/ui/settings-tournament-button-cleanup.js?v=20260906-v1', './js/ui/pending-history-rehydrate.js?v=20260906-game-scope-v1',
