const CACHE_NAME = 'r32-shell-20260905-history-edit-position-v1';
const APP_SHELL = [
  './', './index.html', './manifest.json', './styles/quick-keyboard.css?v=20260905-v1', './js/ui/quick-keyboard.js?v=20260905-v1', './js/ui/game-history-edit-position.js?v=20260905-v1',
