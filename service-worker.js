const CACHE_NAME = 'r32-shell-20260905-pending-history-v1';
const APP_SHELL = [
  './', './index.html', './manifest.json', './styles/quick-keyboard.css?v=20260905-v1', './js/ui/quick-keyboard.js?v=20260905-v1', './js/ui/game-history-edit-position.js?v=20260905-v1', './js/ui/pending-history-rehydrate.js?v=20260905-v1',
